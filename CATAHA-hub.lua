...
Section:NewButton("AntiVoid", "телепортирует в пустоту", function()
    game:GetService("Workspace").PRO_rageBaiter42.HumanoidRootPart.CFrame = CFrame.new(3076.39819, 4349.40625, 7585.1123, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)

Section:NewButton("Snowdin", "телепортирует в сноудин", function()
    game:GetService("Workspace").PRO_rageBaiter42.HumanoidRootPart.CFrame = CFrame.new(4588.96484, -3946.73242, 5373.57471, -0.342006564, -0.939697623, -7.00354576e-06, 7.00354576e-06, -1.00135803e-05, 1, -0.939697623, 0.342006564, 1.00135803e-05)
end)

Section:NewButton("WatterFall", "телепортирует в водопадье", function()
    game:GetService("Workspace").PRO_rageBaiter42.HumanoidRootPart.CFrame = CFrame.new(540.083679, 202.89212, 3383.97778, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end)

Section:NewButton("La jupo hall", "телепортирует в ла джупо коридор", function()
    game:GetService("Workspace").PRO_rageBaiter42.HumanoidRootPart.CFrame = CFrame.new(6582.38965, 2189.19653, 7497.25, -5.25712967e-05, 5.55068254e-06, -1, -0.208693326, -0.977981091, 5.55068254e-06, -0.977981091, 0.208693326, 5.2511692e-05)
end)

Section:NewButton("Baseplate", "телепортирует на басплейт", function()
    game:GetService("Workspace").PRO_rageBaiter42.HumanoidRootPart.CFrame = CFrame.new(16364.2246, 48304.2422, -35074.4141, 0.356812239, 0.934176087, 0, -0.934176087, 0.356812239, -0, -0, 0, 1)
end)
